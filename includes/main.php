    ...
    <div class="page-header__bottomline">
      <div class="container clearfix">
        ...
        <nav class="main-nav">
          ...
          <li class="categories__item">
              <a class="categories__link" href="nurse/my_account.php?edit_account">
                My Account
                    ...
                    <div class="dropdown__heading">Account Settings</div>
						<ul class="dropdown__items">
						  <li class="dropdown__item">
							<a href="nurse/my_account.php?edit_account" class="dropdown__link">Edit Your Account</a>
						  </li>

              <li class="dropdown__item">
							<a href="nurse/my_account.php?view_patient_details" class="dropdown__link">View Patient Details</a>
						  </li>

                          <li class="dropdown__item">
							<a href="nurse/my_account.php?view_patient_menu" class="dropdown__link">View Patient Menu</a>
						  </li>
						  
						  <li class="dropdown__item">
							<a href="nurse/my_account.php?change_pass" class="dropdown__link">Change Password</a>
						  </li>
