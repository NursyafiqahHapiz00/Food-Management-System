...
?>
		...
		<div class="panel-heading" style="background-color: #0077b6;"><!-- panel-heading Starts -->
...
<input class="btn btn-primary" type="submit" name="filter" value="Filter">
						...
						<div>
							...
							<div class="form-group" ><!-- form-group Starts -->
								...
								<center>
								<div class="form-group col-md-12">
										<a href="patient_details.php" type="button" class="btn btn-danger"> Back</a>
									</div>						
							</form>
							...
							<?php						
									if(isset($_POST['add'])){
										...
										$insert_patient_m_menu = "insert into patient_m_menu (patient_id, meals_menu_b_id, meals_menu_l_id, meals_menu_ht_id, meals_menu_d_id) values ('$patient_id', '$meals_menu_b_id', '$meals_menu_l_id', '$meals_menu_ht_id', '$meals_menu_d_id')";
										$run_patient_m_menu = mysqli_query($con,$insert_patient_m_menu);
											...
											if($run_patient_m_menu){
												...
												echo "<script>window.open('view_patient_details.php','_self')</script>";
											}
									}
								?>
