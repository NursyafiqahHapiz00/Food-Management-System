...
<?php
	...
	$query = "update admin set admin_email='$admin_email',admin_pass='$admin_pass',admin_fname='$admin_fname', admin_lname='$admin_lname',admin_contact='$admin_contact',admin_position='$admin_position',admin_image='$admin_image' where admin_id='$edit_id'";
