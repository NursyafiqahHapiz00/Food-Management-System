...
<?php
	...
	$insert_admin = "insert into admin (admin_email, admin_pass, admin_fname, admin_lname, admin_contact, admin_position, admin_image) values ('$admin_email','$admin_pass','$admin_fname', '$admin_lname','$admin_contact','$admin_position','$admin_image') ";
