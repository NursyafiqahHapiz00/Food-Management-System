...
<div class="row"><!-- row Starts -->
	<div class="col-lg-12"><!-- col-lg-12 Starts -->
		<ol class="breadcrumb"><!-- breadcrumb Starts -->
			<li class="active">
				<i class="fa fa-dashboard"> </i> Dashboard / Insert Meals Menu for Dinner
			</li>
		</ol><!-- breadcrumb Ends -->
	</div><!-- col-lg-12 Ends -->
</div><!-- row Ends -->
		...
		<div class="panel panel-default"><!-- panel panel-default Starts -->
			<div class="panel-heading"><!-- panel-heading Starts -->
				<h3 class="panel-title">
					<i class="fa fa-cart-plus"></i> Insert Meals Menu for Dinner
				</h3>
				...
				<?php 
					...
					//to insert in mysql
						...
						$query="INSERT INTO meals_menu_d (meals_portion_id,meals_menu_d,meals_quantity_d,meals_cost) 
